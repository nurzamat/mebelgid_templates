...
<head>
    ...
    <!--<link href="http://almaz.mebel.kz/news" rel="canonical" />-->
...
<div class="layout salonPage">
    ...
    <div class="salonContent">
        <div class="bread gray">
            <span itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><a itemprop="url" href="../content/index.php?city=<?=$salon_city?>" title="Главная"><span itemprop="title">Главная</span></a></span> / <span itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><a itemprop="url" href="../content/salons.php?city=<?=$salon_city?>" title="Мебельные салоны в <?=$user_obj->user_city."е"?>"><span itemprop="title">Мебельные салоны в <?=$user_obj->user_city."е"?></span></a></span> / <span itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><a itemprop="url" href="index.php" title="<?=$user_obj->user_salonname?>"><span itemprop="title"><?=$user_obj->user_salonname?></span></a></span> / <span itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><span itemprop="title">Новости</span></span>
        </div>
        <div class="toCenter">
        ...
        <div style="width: 66.5%; padding-bottom: 30px;">
            <? while($news = mysql_fetch_object($newsQ)) { ?>
                <div class="newsItem">
                    <h3 class="title"><a href="show.php?id=<?=$news->ID?>"><?=$news->title?></a> <small class="smaller gray"><?=$news->createddate?></small></h3> <?=$news->text?>
                </div>
            <? } ?>
        </div>

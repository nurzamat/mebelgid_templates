      ...
      <? include('head.php') ?>
        ...
        <div class="main col1-layout">
            <div class="col-main">
                ...
                <form class="forgot-form" action="" method="post" id="form-validate">
                    <div class="fieldset">
                        <p style="color: #A5886E">Укажите ваш email, и мы отправим вам ваш пароль.</p>
                        <ul class="form-list">
                            <li>
                    ...
                    <div class="buttons-set form-buttons">
                        <p class="back-link"><a style="color: #A5886E" href="login.php"><small>&laquo; </small>Назад</a></p>
                        <button type="submit" class="button"><span><span>Получить пароль</span></span></button>
                    </div>
                </form>
                <script type="text/javascript">
                    //<![CDATA[
        ...
        <script type="text/javascript">
            Event.observe(window, 'load', function() {
                ...
                if(document.getElementById('magestore-sociallogin-popup-email') !=null && document.getElementById('magestore-sociallogin-popup-pass')!=null)
                {
                    var options = {
                        ...
                        login_url  : "https://www.mebelgid.kg/sociallogin/popup/login",
                        send_pass_url : "https://www.mebelgid.kg/sociallogin/popup/sendPass",
                        create_url : "https://www.mebelgid.kg/sociallogin/popup/createAcc"
                    };
            ...
            //<![CDATA[
            var currentSiteSessionId = 'svb72s1nqbqkr67n5ktti8c172';
...
<!-- Google Tag Manager --><noscript><iframe src="//www.googletagmanager.com/ns.html?id=GTM-5P8HHB";
...
<script type="text/javascript">// <![CDATA[
    ...
    })(window,document,'script','dataLayer','GTM-5P8HHB');
    // ]]></script>
